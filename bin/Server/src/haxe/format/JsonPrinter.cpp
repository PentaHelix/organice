...
{
HX_STACK_FRAME("haxe.format.JsonPrinter","new",0xeb68de75,"haxe.format.JsonPrinter.new","D:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",54,0x7eeea2b3)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.format.JsonPrinter","write",0x755dea34,"haxe.format.JsonPrinter.write","D:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",77,0x7eeea2b3)
		HX_STACK_THIS(this)
		HX_STACK_ARG(k,"k")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(78)
								...
								if ((tmp7)){
									...
									struct _Function_7_1{
										inline static Dynamic Block( ){
											HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","D:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",115,0x7eeea2b3)
											{
...
{
		HX_STACK_FRAME("haxe.format.JsonPrinter","fieldsString",0x974bd375,"haxe.format.JsonPrinter.fieldsString","D:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",165,0x7eeea2b3)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
...
{
		HX_STACK_FRAME("haxe.format.JsonPrinter","quote",0x02f6a091,"haxe.format.JsonPrinter.quote","D:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",191,0x7eeea2b3)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(193)
...
{
		HX_STACK_FRAME("haxe.format.JsonPrinter","quoteUtf8",0x88683e62,"haxe.format.JsonPrinter.quoteUtf8","D:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",223,0x7eeea2b3)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(224)
		...
		Void run(int c){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","D:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",225,0x7eeea2b3)
			HX_STACK_ARG(c,"c")
			{
				HX_STACK_LINE(226)
...
::String JsonPrinter_obj::print( Dynamic o,Dynamic replacer,::String space){
	HX_STACK_FRAME("haxe.format.JsonPrinter","print",0x6d8fd582,"haxe.format.JsonPrinter.print","D:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",42,0x7eeea2b3)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(replacer,"replacer")
	HX_STACK_ARG(space,"space")
	HX_STACK_LINE(43)
