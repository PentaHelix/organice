...
int Input_obj::readByte( ){
	HX_STACK_FRAME("haxe.io.Input","readByte",0x4de8a3c2,"haxe.io.Input.readByte","D:\\HaxeToolkit\\haxe\\std/haxe/io/Input.hx",48,0x9ccdbcec)
	HX_STACK_THIS(this)
	HX_STACK_LINE(48)
...
int Input_obj::readBytes( ::haxe::io::Bytes s,int pos,int len){
	HX_STACK_FRAME("haxe.io.Input","readBytes",0xdda6a671,"haxe.io.Input.readBytes","D:\\HaxeToolkit\\haxe\\std/haxe/io/Input.hx",61,0x9ccdbcec)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
...
{
		HX_STACK_FRAME("haxe.io.Input","close",0xfc421af4,"haxe.io.Input.close","D:\\HaxeToolkit\\haxe\\std/haxe/io/Input.hx",87,0x9ccdbcec)
		HX_STACK_THIS(this)
	}
return null();
}
