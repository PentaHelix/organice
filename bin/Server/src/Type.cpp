...
Dynamic Type_obj::createEmptyInstance( ::hx::Class cl){
	HX_STACK_FRAME("Type","createEmptyInstance",0xcb752312,"Type.createEmptyInstance","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",86,0x1797891d)
	HX_STACK_ARG(cl,"cl")
	HX_STACK_LINE(87)
...
::ValueType Type_obj::_typeof( Dynamic v){
	HX_STACK_FRAME("Type","typeof",0xd6c51d65,"Type.typeof","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",112,0x1797891d)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(113)
