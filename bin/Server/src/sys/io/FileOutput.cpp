...
{
HX_STACK_FRAME("sys.io.FileOutput","new",0x19e22a16,"sys.io.FileOutput.new","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",31,0xc71346e1)
HX_STACK_THIS(this)
HX_STACK_ARG(f,"f")
{
	HX_STACK_LINE(31)
...
{
		HX_STACK_FRAME("sys.io.FileOutput","writeByte",0x887099bd,"sys.io.FileOutput.writeByte","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",35,0xc71346e1)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(35)
		try
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
	HX_STACK_FRAME("sys.io.FileOutput","writeBytes",0xda15ec16,"sys.io.FileOutput.writeBytes","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",38,0xc71346e1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(p,"p")
	HX_STACK_ARG(l,"l")
...
{
		HX_STACK_FRAME("sys.io.FileOutput","flush",0x5fbc15fa,"sys.io.FileOutput.flush","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",42,0xc71346e1)
		HX_STACK_THIS(this)
		HX_STACK_LINE(43)
		Dynamic tmp = this->__f;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(43)
...
{
		HX_STACK_FRAME("sys.io.FileOutput","close",0xa583caee,"sys.io.FileOutput.close","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",46,0xc71346e1)
		HX_STACK_THIS(this)
		HX_STACK_LINE(47)
		this->super::close();
		HX_STACK_LINE(48)
