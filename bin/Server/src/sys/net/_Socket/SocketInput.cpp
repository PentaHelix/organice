...
{
HX_STACK_FRAME("sys.net._Socket.SocketInput","new",0x5fe92abb,"sys.net._Socket.SocketInput.new","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",31,0xbc55bbd0)
HX_STACK_THIS(this)
HX_STACK_ARG(s,"s")
{
	HX_STACK_LINE(31)
...
int SocketInput_obj::readByte( ){
	HX_STACK_FRAME("sys.net._Socket.SocketInput","readByte",0xee593543,"sys.net._Socket.SocketInput.readByte","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",34,0xbc55bbd0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(35)
...
int SocketInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("sys.net._Socket.SocketInput","readBytes",0x9fb565d0,"sys.net._Socket.SocketInput.readBytes","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",47,0xbc55bbd0)
	HX_STACK_THIS(this)
	...
	HX_STACK_CATCHABLE(Dynamic, 0);
	{
		...
		HX_STACK_LINE(52)
		int tmp5 = ::sys::net::_Socket::SocketInput_obj::socket_recv(tmp2,buf->b,tmp3,tmp4);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(52)
		r = tmp5;
	}
	}
	...
	HX_STACK_LINE(59)
	bool tmp2 = (r == (int)0);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(59)
	if ((tmp2)){
		HX_STACK_LINE(60)
		::haxe::io::Eof tmp3 = ::haxe::io::Eof_obj::__new();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(60)
...
{
		HX_STACK_FRAME("sys.net._Socket.SocketInput","close",0xbbc7fed3,"sys.net._Socket.SocketInput.close","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",64,0xbc55bbd0)
		HX_STACK_THIS(this)
		HX_STACK_LINE(65)
		this->super::close();
		HX_STACK_LINE(66)
...
static hx::StaticInfo sStaticStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(void *) &SocketInput_obj::socket_recv,HX_HCSTRING("socket_recv","\x72","\x94","\xbb","\x87")},
...
static ::String sStaticFields[] = {
	HX_HCSTRING("socket_recv","\x72","\x94","\xbb","\x87"),
...
{
	socket_recv= ::cpp::Lib_obj::load(HX_HCSTRING("std","\xa3","\xa8","\x57","\x00"),HX_HCSTRING("socket_recv","\x72","\x94","\xbb","\x87"),(int)4);
