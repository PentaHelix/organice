...
{
		HX_STACK_FRAME("sys.net._Socket.SocketOutput","writeByte",0xbfd704fb,"sys.net._Socket.SocketOutput.writeByte","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",83,0xbc55bbd0)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(84)
...
int SocketOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("sys.net._Socket.SocketOutput","writeBytes",0x1c4d5718,"sys.net._Socket.SocketOutput.writeBytes","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",96,0xbc55bbd0)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("sys.net._Socket.SocketOutput","close",0xbcc83f2c,"sys.net._Socket.SocketOutput.close","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",107,0xbc55bbd0)
		HX_STACK_THIS(this)
		HX_STACK_LINE(108)
		this->super::close();
		HX_STACK_LINE(109)
