...
{
		HX_STACK_FRAME("sys.net.Socket","close",0x18d3680f,"sys.net.Socket.close","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",133,0xbc55bbd0)
		HX_STACK_THIS(this)
		HX_STACK_LINE(134)
...
{
		HX_STACK_FRAME("sys.net.Socket","listen",0x81cfc410,"sys.net.Socket.listen","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",166,0xbc55bbd0)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("sys.net.Socket","bind",0xfd253d46,"sys.net.Socket.bind","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",174,0xbc55bbd0)
		HX_STACK_THIS(this)
...
::sys::net::Socket Socket_obj::accept( ){
	HX_STACK_FRAME("sys.net.Socket","accept",0x9cdc8ed1,"sys.net.Socket.accept","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",178,0xbc55bbd0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(179)
	Dynamic tmp = this->__s;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(179)
...
{
		HX_STACK_FRAME("sys.net.Socket","setBlocking",0xe5689b0e,"sys.net.Socket.setBlocking","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",209,0xbc55bbd0)
		HX_STACK_THIS(this)
		HX_STACK_ARG(b,"b")
		HX_STACK_LINE(210)
		Dynamic tmp = this->__s;		HX_STACK_VAR(tmp,"tmp");
