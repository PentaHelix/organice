...
{
HX_STACK_FRAME("cpp.net.ThreadServer","new",0x0d14ad1b,"cpp.net.ThreadServer.new","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",59,0xc823bf7b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(60)
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","runThread",0xa4117b70,"cpp.net.ThreadServer.runThread","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",73,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(t,"t")
		HX_STACK_LINE(73)
		while((true)){
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","readClientData",0xcccc9c30,"cpp.net.ThreadServer.readClientData","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",82,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(83)
		...
		while((true)){
			...
			HX_STACK_LINE(105)
			{
				...
				Void run(){
					HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",105,0xc823bf7b)
					{
						HX_STACK_LINE(105)
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","loopThread",0x84d478f3,"cpp.net.ThreadServer.loopThread","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",112,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(t,"t")
		HX_STACK_LINE(113)
				...
				catch(Dynamic __e){
					{
						...
						Dynamic e = __e;{
							...
							HX_STACK_LINE(122)
							{
								...
								int __ArgCount() const { return 0; }
								Void run(){
									HX_STACK_FRAME("*","_Function_5_1",0x5203f63b,"*._Function_5_1","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",122,0xc823bf7b)
									{
										HX_STACK_LINE(122)
			...
			if ((tmp6)){
				...
				if ((tmp8)){
					...
					HX_STACK_LINE(133)
					{
						...
						int __ArgCount() const { return 0; }
						Void run(){
							HX_STACK_FRAME("*","_Function_5_1",0x5203f63b,"*._Function_5_1","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",133,0xc823bf7b)
							{
								HX_STACK_LINE(133)
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","doClientDisconnected",0x3cbec1f6,"cpp.net.ThreadServer.doClientDisconnected","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",138,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(139)
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","runWorker",0xdef63124,"cpp.net.ThreadServer.runWorker","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",144,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(144)
		while((true)){
			HX_STACK_LINE(145)
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","work",0x6afd48b6,"cpp.net.ThreadServer.work","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",159,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(160)
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","logError",0x618e2609,"cpp.net.ThreadServer.logError","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",163,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(164)
		...
		if ((tmp2)){
			...
			HX_STACK_LINE(168)
			{
				...
				int __ArgCount() const { return 0; }
				Void run(){
					HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",168,0xc823bf7b)
					{
						HX_STACK_LINE(168)
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","addClient",0xb16f9a47,"cpp.net.ThreadServer.addClient","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",171,0xc823bf7b)
		HX_STACK_THIS(this)
				...
				if ((tmp12)){
					...
					struct _Function_4_1{
						inline static Dynamic Block( Dynamic &tmp13,Dynamic &tmp15,::sys::net::Socket &tmp16,::haxe::io::Bytes &tmp18){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",176,0xc823bf7b)
							{
					...
					struct _Function_4_2{
						inline static Dynamic Block( ::sys::net::Socket &sock){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",184,0xc823bf7b)
							{
								hx::Anon __result = hx::Anon_obj::Create();
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","refuseClient",0x4e2e7224,"cpp.net.ThreadServer.refuseClient","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",193,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(sock,"sock")
		HX_STACK_LINE(193)
		sock->close();
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","runTimer",0x1bc915df,"cpp.net.ThreadServer.runTimer","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",196,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(197)
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","init",0x61bb81f5,"cpp.net.ThreadServer.init","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",204,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(205)
			...
			while((true)){
				...
				struct _Function_3_1{
					inline static Dynamic Block( ::cpp::net::Poll &tmp10,int &tmp8){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",208,0xc823bf7b)
						{
							hx::Anon __result = hx::Anon_obj::Create();
				...
				HX_STACK_LINE(215)
				{
					...
					int __ArgCount() const { return 0; }
					Void run(){
						HX_STACK_FRAME("*","_Function_4_1",0x520333fa,"*._Function_4_1","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",215,0xc823bf7b)
						{
							HX_STACK_LINE(215)
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","addSocket",0xcd665baf,"cpp.net.ThreadServer.addSocket","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",219,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(220)
		s->setBlocking(false);
		...
		HX_STACK_LINE(221)
		{
			...
			int __ArgCount() const { return 0; }
			Void run(){
				HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",221,0xc823bf7b)
				{
					HX_STACK_LINE(221)
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","run",0x0d17c406,"cpp.net.ThreadServer.run","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",224,0xc823bf7b)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","onError",0x49b4c064,"cpp.net.ThreadServer.onError","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",254,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
...
Dynamic run(::sys::net::Socket s){
	HX_STACK_FRAME("cpp.net.ThreadServer","clientConnected",0x9d386039,"cpp.net.ThreadServer.clientConnected","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",261,0xc823bf7b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(261)
	return null();
...
Void run(Dynamic c){
{
		HX_STACK_FRAME("cpp.net.ThreadServer","clientDisconnected",0x9c7e144b,"cpp.net.ThreadServer.clientDisconnected","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",264,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
	}
return null();
...
Dynamic run(Dynamic c,::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("cpp.net.ThreadServer","readClientMessage",0x002ef781,"cpp.net.ThreadServer.readClientMessage","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",267,0xc823bf7b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(c,"c")
	...
	struct _Function_1_1{
		inline static Dynamic Block( int &len){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",268,0xc823bf7b)
			{
				hx::Anon __result = hx::Anon_obj::Create();
...
{
		HX_STACK_FRAME("cpp.net.ThreadServer","clientMessage",0x282b7737,"cpp.net.ThreadServer.clientMessage","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",274,0xc823bf7b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
...
Void run(){
{
		HX_STACK_FRAME("cpp.net.ThreadServer","update",0xd8d1102e,"cpp.net.ThreadServer.update","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",277,0xc823bf7b)
		HX_STACK_THIS(this)
	}
return null();
}
...
Void run(){
{
		HX_STACK_FRAME("cpp.net.ThreadServer","afterEvent",0x06082d03,"cpp.net.ThreadServer.afterEvent","D:\\HaxeToolkit\\haxe\\std/cpp/net/ThreadServer.hx",280,0xc823bf7b)
		HX_STACK_THIS(this)
	}
return null();
}
...
bool ThreadServer_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void ThreadServer_obj::__register()
{
	...
	__mClass->mSetStaticField = &ThreadServer_obj::__SetStatic;
