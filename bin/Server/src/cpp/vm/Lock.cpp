...
{
HX_STACK_FRAME("cpp.vm.Lock","new",0x9e13fec9,"cpp.vm.Lock.new","D:\\HaxeToolkit\\haxe\\std/cpp/vm/Lock.hx",27,0x37a6c81f)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(28)
...
Dynamic timeout = __o_timeout.Default(-1);
	HX_STACK_FRAME("cpp.vm.Lock","wait",0xb95ac7ec,"cpp.vm.Lock.wait","D:\\HaxeToolkit\\haxe\\std/cpp/vm/Lock.hx",30,0x37a6c81f)
	HX_STACK_THIS(this)
...
bool Lock_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void Lock_obj::__register()
{
	...
	__mClass->mSetStaticField = &Lock_obj::__SetStatic;
