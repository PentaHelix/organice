...
Dynamic Lib_obj::load( ::String lib,::String prim,int nargs){
	HX_STACK_FRAME("cpp.Lib","load",0xd2b2dcba,"cpp.Lib.load","D:\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",30,0x0493695d)
...
{
		HX_STACK_FRAME("cpp.Lib","rethrow",0x3bf8427f,"cpp.Lib.rethrow","D:\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",81,0x0493695d)
...
{
		HX_STACK_FRAME("cpp.Lib","println",0xca016ddb,"cpp.Lib.println","D:\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",137,0x0493695d)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(137)
		::__hxcpp_println(v);
	}
